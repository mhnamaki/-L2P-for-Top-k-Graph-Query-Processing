...
//
//public class BeamSearchAllTasks {
//	public final int MAX_MEMORY_LIMIT = 1000000;
//	public int beamSize = 0;
//	public int delta = 0;
//	public final int TETA = 1;
//	public int maxDelta;
//	public BeamSearchRunnerAllTasks.WhichOracle oracle;
//	public BeamSearchRunnerAllTasks beamSearchRunner;
...
//	public BeamSearchRunnerAllTasks.MinObjectiveFunction rankingFunction;
...
//
//	public BeamSearchAllTasks(GraphDatabaseService queryGraph, GraphDatabaseService knowledgeGraph, int beamSize,
//			int delta, BeamSearchRunnerAllTasks.WhichOracle oracle, BeamSearchRunnerAllTasks beamSearchRunner,
//			NeighborIndexing neighborIndexingInstance, CacheServer cacheServer,
//			HashMap<Integer, Integer> maxAnyTimeAnswerDepthStarQueryMap, double trueRank, int numberOfQNodes,
//			int numberOfQRelationships, BeamSearchRunnerAllTasks.MinObjectiveFunction rankingFunction, double rankCoeff,
...
//			BeamSearchNode startNode, int beamSize, int delta, BeamSearchRunnerAllTasks.WhichOracle oracle,
//			NeighborIndexing neighborIndexingInstance, CacheServer cacheServer) throws Exception {
//		// initialization
//		// int g = 0;
//
...
//	}
//
//	private ArrayList<BeamSearchNode> generateSuccessors(BeamSearchNode node, int delta,
//			BeamSearchRunnerAllTasks.WhichOracle oracle) throws Exception {
...
//			if (oracle == BeamSearchRunnerAllTasks.WhichOracle.macroSingleAction) {
