...
public class MLQueryRunnerUsingOnePolicy {
	...
	public MLQueryRunnerUsingOnePolicy(String queryFileDirectory, String GDirectory, String GName,
	...
	public MLQueryRunnerUsingOnePolicy() {

	}

	public static void main(String[] args) throws Exception {
		MLQueryRunnerUsingOnePolicy mlqrOverValidation = new MLQueryRunnerUsingOnePolicy();
	...
	public void initialize(String[] args) throws Exception {
		...
		MachineLearningQueryRunnerForOnePolicy mlQueryRunner = new MachineLearningQueryRunnerForOnePolicy(
				knowledgeGraph, queryFileDirectory, GDirectory, GName, startingQueryIndex, endingQueryIndex,
				PATTERNGRAPH_DB_PATH, k, levenshtein, cacheServer, neighborIndexingInstance);
		...
		mlQueryRunner.findSpeedUpAndQualityOutOfAClassifierRegressorForASet(validationQueriesSet,
				ei.getModel("DAggerClassifier_" + modelIndex + ".model"), null, numberOfSameExperiment,
				GName + "WithoutExpansionPolicy_MLRunningTime_" + modelIndex + "_" + modelIndex + ".txt",
				oracleSequenceFile, selectionNormalizationFeaturesVector, expansionNormalizationFeaturesVector);

		mlQueryRunner.findSpeedUpAndQualityOutOfAClassifierRegressorForASet(validationQueriesSet, null,
				(Classifier) ei.getModel("DAggerRegressor_" + modelIndex + ".model"), numberOfSameExperiment,
				GName + "WithoutSelectionPolicy_MLRunningTime_" + modelIndex + "_" + modelIndex + ".txt",
				oracleSequenceFile, selectionNormalizationFeaturesVector, expansionNormalizationFeaturesVector);
