...
public class QuerySeparatorBasedOnSQ {
	...
	public static void main(String[] args) throws Exception {
		QuerySeparatorBasedOnSQ foq = new QuerySeparatorBasedOnSQ();
		foq.initialize(args);
	}
				...
				try (Transaction txG = knowledgeGraph.beginTx()) {
					try (Transaction txQ = queryGraph.beginTx()) {
						...
						queryGenerator.SaveQueryInfo(queryIndex, allNodesForSaving, queryFileName, null, null, null,
								null, neighborIndexingInstance, starFramework2.starQueries.size(), offset);
