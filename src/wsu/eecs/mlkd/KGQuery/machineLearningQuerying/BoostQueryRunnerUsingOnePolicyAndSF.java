...
public class BoostQueryRunnerUsingOnePolicyAndSF {
	...
	public BoostQueryRunnerUsingOnePolicyAndSF(String queryFileDirectory, String GDirectory, String GName,
	...
	public BoostQueryRunnerUsingOnePolicyAndSF() {

	}

	public static void main(String[] args) throws Exception {
		BoostQueryRunnerUsingOnePolicyAndSF mlqrOverValidation = new BoostQueryRunnerUsingOnePolicyAndSF();
	...
	public void initialize(String[] args) throws Exception {
		...
		BoostingQueryRunnerForOnePolicyAndSF bstQueryRunner = new BoostingQueryRunnerForOnePolicyAndSF(
		...
		bstQueryRunner.findSpeedUpAndQualityOutOfAClassifierRegressorForASet(validationQueriesSet,
				...
				GName + "WithoutExpansionPolicy_WithSF_‌BstRunningTime_" + modelIndex + "_" + modelIndex + ".txt",
		...
		bstQueryRunner.findSpeedUpAndQualityOutOfAClassifierRegressorForASet(validationQueriesSet, null,
				...
				numberOfSameExperiment,
				GName + "WithoutSelectionPolicy_WithSF_BstRunningTime_" + modelIndex + "_" + modelIndex + ".txt",
				oracleSequenceFile, selectionNormalizationFeaturesVector, expansionNormalizationFeaturesVector);
